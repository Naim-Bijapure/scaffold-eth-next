                    ...
                    <div className="container mx-auto flex flex-col p-6">
                        ...
                        <div className="divide-y divide-gray-700">
                            <div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
                                <div className="flex items-center justify-center lg:col-span-1 col-span-full text-5xl">
                                    <BsCreditCard2Front />
                                </div>
                                <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                                    ...
                                    <span className="info-block">
                                        ...
                                        <div>
                                            <span>🪝</span>
                                            for example, the
                                            <span className="highlight">useBalance()</span> hook keeps track of your
                                            balance: <b>{formatEther(data?.value as BigNumberish)}</b>
                                            and <span className="highlight">useAccount()</span> hook keeps track of your
                                            account address
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span className=" ">
                                                <AddressInput
                                                    value={accountData?.address as string}
                                                    onChange={() => null}
                                                />
                                            </span>
                                            <span>
                                ...
                                <div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
                                    ...
                                    <span className="mt-4 info-block ">
                                        <div>
                                            ...
                                            <span className="highlight">
                                                packages/foundry-hardat-ts/hardhat.config.js
                                            </span>
                                            and running
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                (use <span className="highlight">yarn run account</span> to display
